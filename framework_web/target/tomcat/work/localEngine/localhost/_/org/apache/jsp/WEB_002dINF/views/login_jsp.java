...
request.setAttribute("basePath", basePath);
      ...
      out.write("  \r\n");
      out.write("  <body>\r\n");
      out.write("     <div class=\"easyui-window\" title=\"登录窗口\" data-options=\"iconCls:'icon-save'\" style=\"width:500px;height:200px;padding:10px;\">\r\n");
      out.write("        <div align=\"center\">\r\n");
      out.write("\t        <form id=\"form\" action=\"login\" method=\"post\">\r\n");
      out.write("\t            <table>\r\n");
      out.write("\t                <tr>\r\n");
      out.write("\t                    <td>用户名:</td>\r\n");
      out.write("\t                    <td><input class=\"easyui-validatebox\" type=\"text\" name=\"userName\" validType=\"length[0,20]\" data-options=\"required:true\"></input></td>\r\n");
      out.write("\t                </tr>\r\n");
      out.write("\t                <tr>\r\n");
      out.write("\t                    <td>密码:</td>\r\n");
      out.write("\t                    <td><input class=\"easyui-validatebox\" type=\"password\" name=\"password\" validType=\"length[0,20]\" data-options=\"required:true\"></input></td>\r\n");
      out.write("\t                </tr>\r\n");
      out.write("\t                <tr>\r\n");
      out.write("\t                    <td>自动登录：</td>\r\n");
      out.write("\t                    <td><input type=\"checkbox\" name=\"rememberMe\" value=\"true\" /> </td>\r\n");
      out.write("\t                </tr>\r\n");
      out.write("\t            </table>\r\n");
      out.write("\t        </form> \r\n");
      out.write("\t        <div >\r\n");
      out.write("\t            <a class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-ok'\" href=\"javascript:void(0)\" onclick=\"login();\">登录</a>\r\n");
      out.write("\t            <a class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-cancel'\" href=\"javascript:void(0)\" onclick=\"$('#form').form('clear');\">重置</a>\r\n");
      out.write("\t        </div>\r\n");
      out.write("\t    </div>\r\n");
      out.write("    </div>\r\n");
      out.write("    ");
      ...
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t    function initBackUrl() {\r\n");
      out.write("\t    \tvar backUrl = \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${param.backUrl }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("\";\r\n");
      out.write("\t    \t$.cookie('backUrl', null);\r\n");
      out.write("\t    \tif (isNotEmpty(backUrl)) {\r\n");
      out.write("\t    \t\t$.cookie('backUrl', encodeURI(backUrl),{ expires: 1, path: '/' });\r\n");
      out.write("\t    \t}\r\n");
      out.write("\t    }\r\n");
      out.write("\t    \r\n");
      out.write("\t    initBackUrl();\r\n");
      out.write("    </script>\r\n");
      out.write("  </body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
  ...
  private boolean _jspx_meth_c_005fif_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/login.jsp(36,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("';\r\n");
        out.write("             if (isNotEmpty(message)) {\r\n");
        out.write("            \t showMsg(message);\r\n");
        out.write("             }\r\n");
        out.write("         </script>\r\n");
        out.write("     ");
