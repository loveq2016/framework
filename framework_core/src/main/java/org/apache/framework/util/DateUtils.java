...
public final class DateUtils {
	...
	public static String getFirstDay(String date) {
		...
		lastDate.setTime(getDate(date, getPattern(date)));
	...
	public static int getWeek(String date) {
	    Calendar cal = Calendar.getInstance();
	    cal.setTime(getDate(date, getPattern(date)));
	    return cal.get(Calendar.DAY_OF_WEEK);
	}
	...
	public static boolean between(String startTime, String endTime,String compareTime,String format) throws ParseException {
	...
	public static boolean betweenByDay(String startTime, String endTime,String compareTime) throws ParseException {
	...
	public static void main(String[] args) {
 	...
 	/*System.out.println(getWeek("2015-06-11"));
 	System.out.println(getDate("dd"));
 	System.out.println("获取当天日期:" + tt.getNowTime());
		...
		System.out.println(getPattern("2015-3"));
		System.out.println(getFirstDay("2015-2"));
		System.out.println(getLastDay("2015-2"));
		System.out.println(addMonth("2015-3-3", 1));
		...
		System.out.println();
		dateDiff("2013-3-23 12:12:12", new SimpleDateFormat(
